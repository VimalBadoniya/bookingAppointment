...
function submitForm(e){
    ...
    axios.post("https://crudcrud.com/api/f5321f60878f478baf1cae1c9554dcac/user" , payload)
    .then((res)=>{
    ...
    */
    ...
    function updateFunction(){
       // console.log(ParentLi)
        ...
        axios.put(`https://crudcrud.com/api/f5321f60878f478baf1cae1c9554dcac/User/${ParentLiId}` , newPayload)
        .then((res)=>{
    ...
    deleteButton.addEventListener("click" , deleteFunction);
     function deleteFunction(){
        ...
        axios.delete(`https://crudcrud.com/api/f5321f60878f478baf1cae1c9554dcac/User/${ParentLiId}`)
...
// if(location.reload){
//     //alert("vimal")
//     axios.get("https://crudcrud.com/api/f5321f60878f478baf1cae1c9554dcac/User")
//     .then((res)=>{
//         let text = ""
